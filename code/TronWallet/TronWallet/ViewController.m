...
-(void)initItems
{
    ...
    TKTabControllerItem *wallet = [[TKTabControllerItem alloc]initWithControllerName:isCold?@"TWColdWalletViewController":@"TWWalletViewController" title:@"WALLET" tabImageName:nil selectedImageName:nil];
